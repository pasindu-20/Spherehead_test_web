...
export default function ContactForm() {
  return (
    <section id="contact-form" className="w-full relative z-10 pt-8 lg:pt-12 pb-0 snap-start">
      ...
      <div className="lg:hidden absolute inset-x-0 top-0 -z-10 bg-white rounded-b-md" style={{ bottom: "18%" }} />
      {/* Desktop white backgrounds */}
      <div className="hidden lg:flex absolute inset-0 -z-10 flex-row">
        <div className="w-1/2 h-[95%] bg-white rounded-b-md" />
        <div className="w-1/2 h-[400px] bg-white rounded-br-md" />
      </div>
      ...
      <SiteContainer>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-24 items-start">
          ...
          <div className="flex flex-col w-full">
            <div className="w-full h-[250px] lg:h-[300px] relative overflow-hidden bg-gray-100 rounded-2xl mt-6 mb-6 lg:mt-0 lg:mb-0">
              <iframe
